...
Na 3.0.1, `jobRun`, refresh de inventário, diagnóstico resumido e cancelamento cooperativo são suportados. Criação/edição/exclusão de job e auto-update remoto permanecem capability-gated/desabilitados até existir mecanismo suportado e homologado.
