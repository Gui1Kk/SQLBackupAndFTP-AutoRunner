...
- O protocolo WSS do MS-C está especificado em `docs/3.0.1/WEBSOCKET_PROTOCOL_DRAFT.md` e validado pelo código compartilhado `services/shared/src/agent-protocol.ts`.
